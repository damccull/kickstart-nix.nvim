...
keymap.set('n', '<leader>q', toggle_qf_list, { desc = 'Toggle diagnostic [Q]uickfix list' })
...
-- INFO: removed because I never used them and nvim has built-in resizing available
